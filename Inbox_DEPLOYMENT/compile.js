...
const inboxPath = path.resolve(__dirname, 'contracts', 'Inbox.sol'); //gives the specific path for compilation
...
module.exports = solc.compile(source, 1).contracts[':Inbox'];  // This exports the compiled list to other files 
